#ifndef BLE_ANIMATION_H
#define BLE_ANIMATION_H
...
class BleAnimation final : public FrameAnimation {
    static constexpr int FRAME_COUNT = 8;
    MicroBitImage frameStorage[FRAME_COUNT];
public:
    explicit BleAnimation(MicroBit& uBit) : FrameAnimation(uBit, FRAME_COUNT, 80, true) { // NOLINT(*-pro-type-member-init)
        constexpr int a = 1;
        constexpr int b = 3;
        constexpr int c = 5;
        constexpr int d = 7;
